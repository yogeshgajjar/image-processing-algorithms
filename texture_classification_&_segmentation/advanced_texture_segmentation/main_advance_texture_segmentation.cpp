...
int main(int argc, char *argv[]) {
    ...
    string file_input{argv[1]}, file_output7{argv[2]}, stringchoice{argv[6]}; 
    ...
    if (stringchoice == "write") {
        ...
        cout << "[INFO] Step 1: Open MATLAB and run the file advance_segmentation.m. That file will read the .txt generated by this program and will perform PCA.\n" << endl;
        cout << "[INFO] Step 2: After executing the all MATLAB files, run the next mode i.e read.\n" << endl;  
    }
    if (stringchoice == "read") {
        cout << "[INFO] Read mode: " << endl;
        feature->readImage(file_input, Imagedata);
        feature->generateImage(Imagedata);
        feature->subtractImageMean();
        feature->applyLawFilters();
