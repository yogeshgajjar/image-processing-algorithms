...
./output_stiching ${PWD%%/}/image_stiching/images/left.raw ${PWD%%/}/image_stiching/images/middle.raw ${PWD%%/}/image_stiching/images/right.raw ${PWD%%/}/image_stiching/stich.raw 720 480 3 
make clean
